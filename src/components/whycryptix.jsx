      ...
      <div className='w-full h-fit centre bordr p-0'>
        <div className="flex bordr mx-15">
          <div className="flex flex-col gap-3 bordr p-3">
            <div className='border centre capsule'><i class="fi fi-rs-shield text-xl"></i></div>
          ...
          <div className="flex flex-col gap-3 bordr p-3">
            <div className='border centre capsule'><i class="fi fi-br-bolt text-xl"></i></div>
          ...
          <div className="flex flex-col gap-3 bordr p-3">
            <div className='border centre capsule'><i class="fi fi-br-down-left-and-up-right-to-center text-xl"></i></div>
          ...
          <div className="flex flex-col gap-3 bordr p-3">
            <div className='border centre capsule'><i class="fi fi-ts-screen text-xl"></i></div>
